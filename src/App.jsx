...
export default function MathLearningPlatform() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] text-[#111827] overflow-x-hidden">
      ...
      {/* HEADER */}
      <header className="sticky top-0 z-50 flex items-center justify-between px-10 h-16 bg-white border-b border-slate-200 shadow-sm">
        ...
        <nav className="hidden md:flex gap-8">
          ...
          <a href="/src/absent" className="nav-link text-[12px] font-medium text-slate-500 hover:text-[#111827] transition-colors no-underline">Video</a>
        </nav>
        <div className="flex items-center gap-2">
          ...
          <a href="/src/profile.html" className="bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-[12px] font-medium px-5 py-2 rounded-md border-none cursor-pointer transition-colors no-underline">Kayıt Ol</a>
        </div>
      </header>

      <main>
        {/* HERO */}
        <section id="anasayfa" className="relative grid grid-cols-1 md:grid-cols-2 items-center min-h-[calc(100vh-64px)] px-10 bg-white overflow-hidden">
          ...
          <div className="relative z-10 pr-8 py-16 hero-animate">
            <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 px-3 py-1.25 rounded-full mb-7">
